<x-section :section_settings="$section_settings" :use_prose="false" class="text-center" inner_class="">
	...
	<blockquote class="text-2xl md:text-3xl italic leading-relaxed mb-6 font-title">
		...
		entered, it was also, however harsh, a place of survival."
	</blockquote>
	<p class="uppercase tracking-widest text-sm font-bold mb-3 font-title text-center">— Llanfyllin Workhouse
		Heritage Centre</p>
	</div>
</x-section>
